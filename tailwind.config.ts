  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'branding-b2': ['1.125rem', { lineHeight: '164%', letterSpacing: '-0.01rem' }],
        'branding-b1': ['1.25rem', { lineHeight: '164%', letterSpacing: '-0.01rem' }],
        'branding-h2': ['1.5rem', { lineHeight: '152%', letterSpacing: '-0.01rem' }],
        'branding-h1': ['1.75rem', { lineHeight: '152%', letterSpacing: '-0.01rem' }],
        'branding-l': ['2rem', { lineHeight: '152%', letterSpacing: '-0.01rem' }],
      },
    },
    backgroundImage: {
