...
export const InstagramIcon = ({ width, height, color = 'white', className = '' }: SVGProps) => (
  ...
  >
    <path
      d="M22.667 2.66675H9.33366C5.65176 2.66675 2.66699 5.65152 2.66699 9.33342V22.6667C2.66699 26.3486 5.65176 29.3334 9.33366 29.3334H22.667C26.3489 29.3334 29.3337 26.3486 29.3337 22.6667V9.33342C29.3337 5.65152 26.3489 2.66675 22.667 2.66675Z"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
